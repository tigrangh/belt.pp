...
int main()
{
    ...
    vectJson.push_back(make_pair("success","{\"face\": \"😂\" }"));
    vectJson.push_back(make_pair("success","{\"testing\":\"ab\u263Ade\"}"));
    ...
    vectJson.push_back(make_pair("success","{\"π\": \"Math.PI\",\"ø\": [],\"Ø\": null,\"e\": 2.7182818284590452353602874713527,\"root2\": 2.7182818284590452353602874713527,\"α\": 2.5029,\"δ\": 4.6692,\"ζ\": 1.2020569,\"φ\": 1.61803398874,\"γ\": 1.30357,\"K\": 2.6854520010,\"oo\": 9999999999e9,\"A\": 1.2824271291,\"C10\": 0.12345678910111213141516171819202122232425252728293031323334353637,\"c\": 299792458}"));
    vectJson.push_back(make_pair("success","{\"moji_string\":\"⛲ ⛳ ⛺ ⛽ ✅ ✉ ✌ 〽\",\"moji_array\":[\"️1️⃣\",\"️2️⃣\",\"️3️⃣\",\"️4️⃣\",\"️5️⃣\",\"️6️⃣\",\"️7️⃣\",\"️8️⃣\"],\"moji_index\":{\"⛲\":\"fountain\",\"⛳\":\"golf\",\"⛺\":\"tent\",\"⛽\":\"fuelpump\"}}"));
    vectJson.push_back(make_pair("success","{\"age\":18,\"address\": {\"streetAddr\": \"国定东路\", \"city\": \"上海\"},\"phones\": [110,12306],\"date\":0}"));
    //
    bool isPass{true};
