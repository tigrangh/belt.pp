...
int main()
{
    ...
    vectJson.push_back(make_pair(u8"success","{\"face\": \"😂\" }"));
    ...
    vectJson.push_back(make_pair(u8"success","{\"Emoji_string\":\"⛲ ⛳ ⛺ ⛽ ✅ ✉ ✌ 〽\",\"moji_array\":[\"️1️⃣\",\"️2️⃣\",\"️3️⃣\",\"️4️⃣\",\"️5️⃣\",\"️6️⃣\",\"️7️⃣\",\"️8️⃣\"],\"moji_index\":{\"⛲\":\"fountain\",\"⛳\":\"golf\",\"⛺\":\"tent\",\"⛽\":\"fuelpump\"}}"));
    ...
    vectJson.push_back(make_pair("success","{\"Emoji in JSON\": \"I \u2661 JSON\"}"));
    ...
    vectJson.push_back(make_pair("success","{\"π\": \"Math.PI\",\"var\": 4,\"foo bar\": 5,\"\": 7}"));
    vectJson.push_back(make_pair("success","{\"keyword\":\"Hello guy! \xF0\x9F\x98\x84\"}"));
    vectJson.push_back(make_pair("success","[{\"keyword\":\"Hey! \\uD83D\\uDE01\"}]"));
    vectJson.push_back(make_pair("attempt","{\"message\":\"jjasdajdasjdj laslla aasdasd ssdfdsf!!! \\u{1F3FD}\", \"updated_time\":\"2015-04-14T22:37:13+0000\", \"id\":\"145193995506_148030368559\"}")); //by online - success
